...
//         key={slide?._id}
//         id={`slide${slide?._id}`}
//           className="carousel-item relative w-full bg-[red] flex justify-center items-center "
//         >
//           {/* Image */}
//           <img
//             src={slide.image}
...
//     {/* mini image  */}
//       <div className="flex  justify-center items-center w-[80%] m-auto transform left-[50%] translate-x-[-50%] absolute bottom-[-50px] bg-white shadow-sm   h-[200px]  space-x-3 p-4">
//       {slides.map((slide, index) => (
//         <div className=" bottom-0 z-10 ">
//           <img src={slide.image} className="w-[200px] h-[100px] object-cover border rounded" alt="" 
//             key={slide._id}
